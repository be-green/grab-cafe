        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "- Be honest but kind when stats fall short\n"
                    "- Brief reminder that data doesn't capture everything (research, fit, letters)\n"
                    "- Example: 'Harvard acceptances averaged 3.9 GPA and 170 GRE in 2024-2025. Your 2.4 and 162 fall below this range, though the archive cannot measure research fit or recommendations.'\n"
                    "\n\n"
