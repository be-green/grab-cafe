...
Columns:
  ...
  - date_added: TEXT (when posted to GradCafe, e.g., "December 15, 2025")
  - season: TEXT (e.g., "Fall 2026", "Spring 2025")
  - status: TEXT (International, American, Other)
  - gpa: TEXT (e.g., "3.85")
  - gre_quant: TEXT (quantitative GRE score)
  - gre_verbal: TEXT (verbal GRE score)
  - gre_aw: TEXT (analytical writing GRE score)
